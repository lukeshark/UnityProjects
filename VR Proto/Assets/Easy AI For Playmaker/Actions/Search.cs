...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class Search : FsmStateAction {
		...
		public override  void OnUpdate()
		{
			...
			LayerMask layerNull = -1;
			// Detect if any objects are within sight
			returnedObject.Value = MovementUtility.WithinSight(Owner.transform, offset.Value, fieldOfViewAngle.Value, viewDistance.Value, ActionHelpers.LayerArrayToLayerMask(objectLayerMask, invertMask.Value), targetOffset.Value,layerNull);
