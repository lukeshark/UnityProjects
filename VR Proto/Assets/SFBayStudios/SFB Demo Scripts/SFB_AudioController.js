...
class AudioClips{
	...
	var chanceOfPlaying	: int				= 100;				// % chance that the clip will play
...
function PlayAudio(name : String){
	...
	if (Random.Range(0,100) >= (100 - audioClips[id].chanceOfPlaying))	// Range of 0-99, compared to 100 - %.  So 0 = 100, and will never be chosen.
	{
