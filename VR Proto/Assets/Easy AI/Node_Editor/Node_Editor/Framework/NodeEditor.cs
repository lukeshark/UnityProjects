...
namespace NodeEditorFramework
{
	...
	{
		public static string editorPath = "Assets/Easy AI/Node_Editor/Node_Editor/";

		// The NodeCanvas which represents the currently drawn Node Canvas; globally accessed
		public static MainNodeCanvas curNodeCanvas;
		...
		// Canvas Editing
		private static Stack<MainNodeCanvas> editCanvasStack = new Stack<MainNodeCanvas> (4);
		...
		/// </summary>
		public static void DrawCanvas (MainNodeCanvas nodeCanvas, NodeEditorState editorState)  
		{
		...
		/// </summary>
		private static void DrawSubCanvas (MainNodeCanvas nodeCanvas, NodeEditorState editorState)  
		{
			if (!editorState.drawing)
				return;
		...
		public static void BeginEditingCanvas (MainNodeCanvas canvas)
		{
			NodeEditorState state = canvas.editorStates.Length >= 1? canvas.editorStates[0] : null;
			BeginEditingCanvas (canvas, state);
		}

		public static void BeginEditingCanvas (MainNodeCanvas canvas, NodeEditorState state)
		{
		...
		public static Node NodeAtPosition (NodeEditorState editorState, Vector2 canvasPos, out NodeKnob focusedKnob)
		{
			...
			if (NodeEditorInputSystem.shouldIgnoreInput (editorState))
				return null;
			MainNodeCanvas canvas = editorState.canvas;
