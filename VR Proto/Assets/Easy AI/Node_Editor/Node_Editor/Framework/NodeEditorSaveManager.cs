...
namespace NodeEditorFramework 
{
	...
	public static partial class NodeEditorSaveManager 
	{
		...
		/// </summary>
		public static void SaveSceneNodeCanvas (string saveName, ref MainNodeCanvas nodeCanvas, bool createWorkingCopy, bool safeOverwrite = true) 
		{
			...
			if (nodeCanvas.GetType () == typeof(MainNodeCanvas)) throw new UnityException ("Cannot save NodeCanvas: The NodeCanvas has no explicit type: '" + nodeCanvas.GetType ().ToString () + "'. Please convert it to a valid type!");
			...
			MainNodeCanvas savedCanvas = nodeCanvas;
			// Preprocess canvas
		...
		/// </summary>
		public static MainNodeCanvas LoadSceneNodeCanvas (string saveName, bool createWorkingCopy)
		{
			if (string.IsNullOrEmpty (saveName))
			{
			...
			MainNodeCanvas savedCanvas = sceneSave.savedNodeCanvas;
		...
		/// </summary>
		public static void SaveNodeCanvas (string path, MainNodeCanvas nodeCanvas, bool createWorkingCopy, bool safeOverwrite = true) 
		{
		#if !UNITY_EDITOR
			...
			MainNodeCanvas canvasSave = nodeCanvas;
			...
			MainNodeCanvas prevSave;
			if (safeOverwrite && (prevSave = ResourceManager.LoadResource<MainNodeCanvas> (path)) != null && prevSave.GetType () == canvasSave.GetType ()) // OVERWRITE
		...
		/// </summary>
		public static MainNodeCanvas LoadNodeCanvas (string path, bool createWorkingCopy) 
		{
			...
			MainNodeCanvas nodeCanvas = ResourceManager.LoadResource<MainNodeCanvas> (path);
		...
		/// </summary>
		private static void ProcessCanvas (ref MainNodeCanvas canvas, bool workingCopy) 
		{
		...
		/// </summary>
		public static MainNodeCanvas CreateWorkingCopy (MainNodeCanvas nodeCanvas, bool editorStates) 
		{
			nodeCanvas.Validate (true);
		...
		/// This breaks the link of this object to any stored assets and references. That means, that all changes to this object will have to be explicitly saved.
		/// </summary>
		private static NodeEditorState[] CreateWorkingCopy (NodeEditorState[] editorStates, MainNodeCanvas associatedNodeCanvas) 
		{
		...
		/// </summary>
		public static NodeEditorState ExtractEditorState (MainNodeCanvas canvas, string stateName) 
		{
		...
		/// </summary>
		public static void OverwriteCanvas (ref MainNodeCanvas canvas, MainNodeCanvas canvasData)
		{
		#if UNITY_EDITOR
			if (canvasData == null)
				throw new System.ArgumentNullException ("Cannot overwrite canvas as data is null!");
			if (canvas == null)
				canvas = ScriptableObject.CreateInstance(canvasData.GetType ()) as MainNodeCanvas;
