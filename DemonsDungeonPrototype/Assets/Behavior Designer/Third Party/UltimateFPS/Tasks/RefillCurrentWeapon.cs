...
{
    [TaskDescription("Refills the current weapon.")]
    ...
    public class RefillCurrentWeapon : Action
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            return agent.RefillCurrentWeapon.Try() ? TaskStatus.Success : TaskStatus.Failure;
        }
