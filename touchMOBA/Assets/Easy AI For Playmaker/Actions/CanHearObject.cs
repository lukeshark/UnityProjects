...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class CanHearObject : FsmStateAction {
		...
		private  float fieldOfViewAngle = 360f;
		...
		public override void OnDrawActionGizmos()
		{
			...
			UnityEditor.Handles.DrawSolidArc(Owner.transform.TransformPoint(offset.Value), (usePhysics2D.Value ? Owner.transform.forward : Owner.transform.up), beginDirection, fieldOfViewAngle, hearingRadius.Value);
