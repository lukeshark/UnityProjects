...
Shader "Hidden/Colorful/Lookup Filter 2D"
{
	...
	CGINCLUDE
		...
		{
			return lookup_gamma(StereoScreenSpaceUVAdjust(i.uv, _MainTex_ST));
		}

		half4 frag_linear(v2f_img i) : SV_Target
		{
			return lookup_linear(StereoScreenSpaceUVAdjust(i.uv, _MainTex_ST));
		}
		...
		{
			return lookup_gamma_nn(StereoScreenSpaceUVAdjust(i.uv, _MainTex_ST));
		}

		half4 frag_linear_nn(v2f_img i) : SV_Target
		{
			return lookup_linear_nn(StereoScreenSpaceUVAdjust(i.uv, _MainTex_ST));
		}
